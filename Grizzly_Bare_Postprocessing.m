...
filename_1 = 'Grizzly_Bare_Heat_Flow_data_Left_side.dat';
...
% Read measured heat flow data
filename_2 = 'Grizzly_Bare_Heat_Flow_data_Right_side.dat';
...
% Read model limits 
% Surface
filename_4 = 'Grizzly_Bare_surface.dat';
...
filename_5 = 'Grizzly_Bare_sediments_basalt_limit.dat';
...
fclose(fid_5);
% Top of the basement
filename_6 = 'Grizzly_Bare_top_basement.dat';
...
% plot the temperature (in degC)
   ...
   hold on;
% plot temperature contours (in degC, every 20 degC)
   [c, h] = contour(X,Y,U(:,:,L+1,IDER,IEQ)-273,'LineColor','black', 'LevelList', 20:20:120);
   clabel(c)
   shading interp;
