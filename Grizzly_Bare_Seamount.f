...
C##############################################################################
      TITLE = ' '                                                              
      TITLE = ' Heat Flux Vector ' 
c      call dtdprx(tout8z,nsave,iset1,iset2,isinc)                              
c      do 78757 is8z=iset1,iset2,isinc                                          
c      call dtdpla(uout(0,0,ivarxa8z,ivarxb8z,is8z),uout(0,0,ivarya8z,iva       
c     &ryb8z,is8z),nx,ny,xa,ya,hx8z,hy8z,inrg8z,xbd8z,ybd8z,nbd8z,title,v       
c     &r1mag,vr2mag,nodist,tout8z(is8z))                                        
c78757 continue                                                                 
78755 continue                                                                 
      call endgks                                                              
      stop                                                                     
...
C We use an initial constant seawater average density
      RHO = 1050.
      G = 9.81
C The value of 2650. (m) is the real seafloor depth around Grizzly Bear seamount
...
C We use an initial constant seawater average density (kg/m3)
      RHO = 1050.
C The value of 2650. (m) is the real seafloor depth around Baby Bear seamount
C The value of h3. (m) is our top Y coordinate
      DEPTH = h3+2650.
      Press = (DEPTH-Y)*RHO*G
C                                                  FB1 DEFINED                 
...
C       ******* ADD POSTPROCESSING CODE HERE: 
    ...
    9 format (' T = ',E15.5,//,'          X    ','          Y    ',
     &  '    z-Heat Flux',/)
C   print vertical heat flux at very top of peak
      i = 0
      j = ny
      write (19,10) xout(i,j),yout(i,j),uout(i,j,3,2,k),inrg(i,j)
      write (19,11) 
   11 format (/)
C print vertical heat flux along depth yj 
